...
type ProjectdetailsDocumentDataSlicesSlice = ImageBlockSlice | TextBlockSlice;
...
interface ProjectdetailsDocumentData {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: projectdetails.title
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
   ...
   * - **Field Type**: Date
   * - **Placeholder**: *None*
   * - **API ID Path**: projectdetails.date
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#date
   */
  date: prismic.DateField;
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: projectdetails.hover_image
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  hover_image: prismic.ImageField<never>;
...
interface SettingsDocumentData {
  ...
  /**
   * Linked in Link field in *settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.linked_in_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface ContentIndexSliceDefaultPrimary {
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.des
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface TechListSliceDefaultPrimaryTechsItem {
  ...
  /**
   * Tech Colour field in *TechList → Default → Primary → Techs*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.techs[].tech_colour
